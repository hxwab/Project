				...
				<textarea id="list_template" style="display:none;">
						<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-striped table-bordered dataTable no-footer">
			                ...
			                <tr>
			                    ...
			                    <td >${item.laData[2]}</td>
			                    <td >${item.laData[3]}</td>
			                    <td>{if item.laData[4]==1}启用{else}停用{/if}</td>
			                    <td>
			                    	{if item.laData[5]==1}高级管理员
			                    	{elseif item.laData[5]==2}一般管理员
			                    	{elseif item.laData[5]==3}高校管理员
			                    	{elseif item.laData[5]==4}评审专家组长
			                    	{elseif item.laData[5]==5}评审专家
			                    	{else}申请人
			                    	{/if}
			                    </td>
			                </tr>
