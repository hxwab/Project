...
<html>
    ...
    <body>
   		...
   		<div class="row">
			  ...
			  <li><a href="#">首页</a></li>
			  <li class="active">新闻通知</li>
			</ol>
   		</div>
			<div class="row mySlide">
			    <div class="col-xs-3 sidebar1 view-nav-bar no-padding-right">
		        	<div><a href="#"><i class="fa fa-newspaper-o fa-2"></i>&nbsp;新闻通知&nbsp;>></a></div>
					<div><a href="#"><i class="fa fa-book fa-2"></i>&nbsp;社科动态&nbsp;>></a></div>
					<div><a href="#"><i class="fa fa-question-circle fa-2"></i>&nbsp;注意事项&nbsp;>></a></div>
			    </div>
			    
			    <div class="col-xs-9 sidebar2 no-padding-left">
				    <%--<div class="list-photo">
						<img src="http://placehold.it/711x390/98ADC8/fff/?text=占位图片" alt="">
					</div>
					--%><div id="simple_search" style="display: none !important;">
		                <form id="search" name="search" action="jsp/portal/list.json" method="post"
		                      class="form-inline">
				...
				<textarea id="list_template" style="display:none;">
						<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0"
			                ...
			                <tr class="table_title_tr">
			                    <td width="50">序号</td>
			                    <td width=""><a id="sortcolumn0" href="" class="{if sortColumn == 0}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按项目名称排序">新闻</a></td>
			                    <td width="100"><a id="sortcolumn1" href="" class="{if sortColumn == 1}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按申请人排序">发布时间</a></td>
			                </tr>
			                </thead>
			                <tbody>
			                {for item in root}
			                <tr>
			                    <td>${item.num}</td>
			                    <td class="table_txt_td"><a href="${item.laData[0]}" title="点击查看详细信息" type="1">${item.laData[1]}</a>
			                    </td>
			                    <td>${item.laData[2]}</td>
			                </tr>
			                {forelse}
		...
		<script>
		    seajs.use("js/portal/list.js", function(list) {
		         list.init(); 
		    });
		</script>
	</body>
