...
public class ApplyAction extends BaseAction {
	...
	//作者所属机构名称
	private String productAgencyId; //项目依托机构
	...
	public String add() {
		...
		map.put("productAgencyId",productAgencyId);
...
//		entityId="4028d88e504badea01504bae67460000";
	...
	public String getProductAgencyId() {
		return productAgencyId;
	}

	public void setProductAgencyId(String productAgencyId) {
		this.productAgencyId = productAgencyId;
	}
